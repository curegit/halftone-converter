...
parser.add_argument("-l", "--gray-intent", type=intent, choices=["per", "sat", "rel", "abs", 0, 1, 2, 3], default="rel", help="rendering intent for transform to Gray images")
parser.add_argument("-R", "--rgb-profile", metavar="RGB_ICC_FILE", help="specify ICC profile for transform to RGB images")
parser.add_argument("-r", "--rgb-intent", type=intent, choices=["per", "sat", "rel", "abs", 0, 1, 2, 3], default="rel", help="rendering intent for transform to RGB images")
parser.add_argument("-C", "--cmyk-profile", metavar="CMYK_ICC_FILE", help="specify ICC profile for transform to CMYK images")
parser.add_argument("-c", "--cmyk-intent", type=intent, choices=["per", "sat", "rel", "abs", 0, 1, 2, 3], default="rel", help="rendering intent for transform to CMYK images")
...
parser.add_argument("--key-from", metavar="RATE", type=rate, help="black ingredient threshold within 0.0-1.0 for RGB-CMYK conversion")
